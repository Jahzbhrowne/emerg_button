...
def ambulance():
    ...
    ambu2 = "There's been an emergency at this place."
    ambu3 = "Urgent help is needed right now."
...
def fire():
    ...
    fire2 = "There's been an emergency at this place."
    fire3 = "Urgent help is needed right now."
...
def police():
    ...
    payload2 = "There's been an emergency at this place."
    payload3 = "Urgent help is needed right now."
